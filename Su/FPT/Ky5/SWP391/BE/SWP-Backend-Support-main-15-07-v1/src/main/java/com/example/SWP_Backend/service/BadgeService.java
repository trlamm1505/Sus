...
public class BadgeService {
    ...
    public List<UserBadge> awardBadgesIfEligible(Integer userId) {
        ...
        if (percentCompleted >= 50) {
            userBadgeRepository.save(new UserBadge(null, userId, "Nói láo á má ơi", "Hoàn thành ít nhất 50% tiến trình cai thuốc!"));
        }
        if (percentCompleted == 100) {
            userBadgeRepository.save(new UserBadge(null, userId, "Có cai được đâu mà tự cao tự đại", "Hoàn thành toàn bộ tiến trình cai thuốc!"));
        }
