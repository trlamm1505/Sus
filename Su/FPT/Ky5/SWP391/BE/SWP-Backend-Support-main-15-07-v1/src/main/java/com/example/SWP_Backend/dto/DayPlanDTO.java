...
public class DayPlanDTO {
    ...
    private int so_ngay_trong_giai_doan;
    ...
    public DayPlanDTO(String mucDoKeHoach, int so_ngay_trong_giai_doan, int day, int stageOrder, String stageName, String goal, List<String> activities) {
        this.mucDoKeHoach = mucDoKeHoach;
        this.so_ngay_trong_giai_doan = so_ngay_trong_giai_doan;
        this.day = day;
    ...
    public int getSo_ngay_trong_giai_doan() {
        return so_ngay_trong_giai_doan;
    }

    public void setSo_ngay_trong_giai_doan(int so_ngay_trong_giai_doan) {
        this.so_ngay_trong_giai_doan = so_ngay_trong_giai_doan;
    }
